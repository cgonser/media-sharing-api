...
#[UniqueEntity(fields: ['video', 'user'])]
class VideoLike implements TimestampableInterface, SoftDeletableInterface
{
    ...
    #[ORM\ManyToOne(targetEntity: Video::class, inversedBy: 'videoLikes')]
    private Video $video;
